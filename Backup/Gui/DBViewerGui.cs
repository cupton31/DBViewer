...
namespace DBViewer.Gui
{
	...
	public class DBViewerGui : Form , IDBViewerGui 
	{
		...
		#region Singelton - Private Static Instance.
		/// <summary>
		/// Instance member.
		/// </summary>
		private static DBViewerGui instance;
		#endregion Singelton - Private Static Instance.
		
		#region DatabaseTreeView, Splitter - Private Members.
		/// <summary>
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(DBViewerGui));
			this.splitter = new System.Windows.Forms.Splitter();
			this.dbViewerMenu = new System.Windows.Forms.MainMenu();
			...
			this.helpMenuItem.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																						 this.aboutMenuItem});
			this.helpMenuItem.MergeOrder = 3;
			this.helpMenuItem.Text = "&Help";
			// 
			// aboutMenuItem
			// 
			this.aboutMenuItem.Index = 0;
			this.aboutMenuItem.Text = "&About DBViewer ...";
			this.aboutMenuItem.Click += new System.EventHandler(this.AboutMenuItemEventHandler);
			// 
			// DBViewerGui
			// 
